...
def get_parsed_arguments():
    ...
    parser.add_argument('--titles', '-t', '--titles title', '-t title', default='--titles', help='sort by titles')
    parser.add_argument('--titles year', '-t year', default='--titles', help='sort by titles')
